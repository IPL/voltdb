...
public class Database extends CatalogType {
    ...
    void setBaseValues(Catalog catalog, CatalogType parent, String path, String name) {
        ...
        m_fields.put("securityprovider", m_securityprovider);
    }

    void update() {
        m_schema = (String) m_fields.get("schema");
        m_securityprovider = (String) m_fields.get("securityprovider");
    }
    ...
    public void setSecurityprovider(String value) {
        m_securityprovider = value; m_fields.put("securityprovider", value);
    }
