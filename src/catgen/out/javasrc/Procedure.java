...
public class Procedure extends CatalogType {
    ...
    void setBaseValues(Catalog catalog, CatalogType parent, String path, String name) {
        ...
        m_fields.put("defaultproc", m_defaultproc);
        m_fields.put("hasjava", m_hasjava);
        m_fields.put("hasseqscans", m_hasseqscans);
        m_fields.put("language", m_language);
    ...
    void update() {
        ...
        m_defaultproc = (Boolean) m_fields.get("defaultproc");
        m_hasjava = (Boolean) m_fields.get("hasjava");
        m_hasseqscans = (Boolean) m_fields.get("hasseqscans");
        m_language = (String) m_fields.get("language");
    ...
    public void setDefaultproc(boolean value) {
        m_defaultproc = value; m_fields.put("defaultproc", value);
    }
    ...
    public void setHasseqscans(boolean value) {
        m_hasseqscans = value; m_fields.put("hasseqscans", value);
    }

    /** SETTER: What language is the procedure implemented with */
    public void setLanguage(String value) {
        m_language = value; m_fields.put("language", value);
    }
