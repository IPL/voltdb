...
public class Table extends CatalogType {
    ...
    void setBaseValues(Catalog catalog, CatalogType parent, String path, String name) {
        ...
        m_fields.put("signature", m_signature);
        m_fields.put("tuplelimit", m_tuplelimit);
    }

    void update() {
        m_isreplicated = (Boolean) m_fields.get("isreplicated");
        m_estimatedtuplecount = (Integer) m_fields.get("estimatedtuplecount");
        m_signature = (String) m_fields.get("signature");
        m_tuplelimit = (Integer) m_fields.get("tuplelimit");
    }
    ...
    public void setSignature(String value) {
        m_signature = value; m_fields.put("signature", value);
    }

    /** SETTER: A maximum number of rows in a table */
    public void setTuplelimit(int value) {
        m_tuplelimit = value; m_fields.put("tuplelimit", value);
    }
